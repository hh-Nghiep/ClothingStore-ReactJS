...
export default function User() {
    ...
    useEffect(() => {
        getUsers();
    }, [arrUser?.length, idRole, statusUser])
                        ...
                        <div className="card shadow mb-4">
                            <div className="card-header py-3" style={{ marginBottom: "5px" }}>
                                <h6 className="m-0 font-weight-bold text-primary">
                                    ...
                                    <Button variant="success" onClick={handleShow} style={{ position: "absolute", top: "15px", right: "10px" }}>Thêm Tài Khoản Mới</Button>
                                </h6>
                            </div>
                                            ...
                                            {arrUser?.map((item, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{item.maQuyen}</td>
                                                        <td>
                                                            <button onClick={() => handleShow1(`${item.maNguoiDung}`)} style={{ marginRight: "10px" }}><FontAwesomeIcon icon={faPenToSquare} style={{ color: "green", cursor: "pointer" }} /></button>
                                                            {' '}
                                                            <button onClick={() => { disableUser(`${item.maNguoiDung}`) }} ><FontAwesomeIcon icon={faTrash} style={{ color: "red", cursor: "pointer" }} /></button>
                                                            {' '}
