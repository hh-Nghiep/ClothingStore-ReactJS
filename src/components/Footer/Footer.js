        ...
        <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
            <div className="row px-xl-5 pt-5">
                <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3" />127 Bình Quới, Bình Thạnh</p>
                    <p className="mb-2"><i className="fa fa-envelope text-primary mr-3" />nghiephh2000@gmail.com</p>
                    <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3" />+0981 171 271</p>
                </div>
